...
Il progetto segue rigorosamente il pattern **Model-View-Controller (MVC)**.

## 📂 Model

Contiene la logica dei dati e lo stato del gioco.
...
Gestisce l'interfaccia grafica JavaFX.
...
Gestisce il salvataggio e il caricamento delle partite.
